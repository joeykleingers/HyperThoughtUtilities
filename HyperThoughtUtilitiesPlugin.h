...
#include "HyperThoughtUtilities/HyperThoughtUtilitiesDLLExport.h"

/**
 * @brief The HyperThoughtUtilitiesPlugin class
 */
class HyperThoughtUtilities_EXPORT HyperThoughtUtilitiesPlugin : public QObject, public ISIMPLibPlugin
{
    Q_OBJECT
    Q_INTERFACES(ISIMPLibPlugin)
    Q_PLUGIN_METADATA(IID "com.your.domain.HyperThoughtUtilitiesPlugin")

  public:
    HyperThoughtUtilitiesPlugin();
   ~HyperThoughtUtilitiesPlugin() override;
  ...
  private:
    ...
    HyperThoughtUtilitiesPlugin(const HyperThoughtUtilitiesPlugin&); // Copy Constructor Not Implemented
    void operator=(const HyperThoughtUtilitiesPlugin&); // Operator '=' Not Implemented
};
